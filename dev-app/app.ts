...
export class App {
  ...
  configureRouter(config: RouterConfiguration, router: Router) {
    ...
    config.map([
      ...
      { route: "richTextEditor", name: "richTextEditor", moduleId: PLATFORM.moduleName("richTextEditor/richTextEditorDemo") },
      ...
      { route: "timeline", name: "timeline", moduleId: PLATFORM.moduleName("timeline/timelineDemo") },
