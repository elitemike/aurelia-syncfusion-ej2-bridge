...
export const ControlBindings = {
  ...
  chart:{
    oneWay: ["accumulationDistributionIndicatorModule","allowExport", "allowMultiSelection", "annotationModule", "annotations", "areaSeriesModule", "atrIndicatorModule", "axes","background", "backgroundImage", "barSeriesModule", "bollingerBandsModule", "border", "boxAndWiskerSeriesModule", "bubbleSeriesModule", "candleSeriesModule", "categoryModule", "chartArea", "columnSeriesModule", "columns", "crosshair", "crosshairModule", "dataEditingModule", "dataLabelModule", "dataSource", "dateTimeCategoryModule", "dateTimeModule","description", "eMAIndicatorModule", "enableAnimation", "enableAutoIntervalOnBoxAxis", "enableCanvas", "enableExport", "enableSideBySidePlacement", "errorBarModule", "exportModule", "height", "highlightMode", "highlightPattern","hiloOpenCloseSeriesModule", "hiloSeriesModule", "histogramSeriesModule", "indicators","isMultiSelect", "isTransposed", "legendModule", "legendSettings", "lineSeriesModule", "logarithmicModule", "macdIndicatorModule", "margin", "momentumIndicatorModule", "margin", "momentumIndicatorModule", "multiColoredAreaSeriesModule", "multiColoredLineSeriesModule","multiLevelLabelModule", "palettes", "paretoSeriesModule", "polarSeriesModule", "primaryXAxis", "primaryYAxis", "radarSeriesModule", "rangeAreaSeriesModule", "rangeColumnSeriesModule", "rows", "rsiIndicatorModule", "sMAIndicatorModule", "scatterSeriesModule", "scrollBarModule", "selectedDataIndexes", "selectionModel", "selectionModule", "selectionPattern", "series","splineAreaSeriesModule", "splineSeriesModule", "stackingAreaSeriesModule", "stackingBarSeriesModule", "stackingColumnSeriesModule", "stackingLineSeriesModule", "stackingStepAreaSeriesModule","stepAreaSeriesModule","stepLineSeriesModule", "stochasticIndicatorModule", "stripLineModule", "subTitle", "subTitleStyle", "tMAIndicatorModule", "tabIndex", "theme", "title", "titleStyle", "tooltip", "tooltipModule", "trendLineModule","useGroupingSeparator", "waterfallSeriesModule", "width", "zoomModule", "zoomSettings"],
    twoWay: [],
    events: ["afterExport", "annimationComplete", "annotationRender" ,"axisLabelClick", "axisLabelRender", "axisMultiLabelRender", "axisRangeCalculated", "beforeExport", "beforePrint", "chartMouseClick", "chartMouseDown", "chartMouseLeave", "chartMouseMove", "chartMouseUp", "drag","dragComplete", "dragEnd", "dragStart", "legendClick", "legendRender", "load", "loaded", "multiLevelLabelClick", "onZooming", "pointClick", "pointDoubleClick", "pointMove", "pointRender", "resized", "scrollChanged", "scrollEnd", "scrollStart", "selectionComplete","seriesRender", "sharedTooltipRender", "textRender", "tooltipRender", "zoomComplete"]
  },
  checkbox: {
